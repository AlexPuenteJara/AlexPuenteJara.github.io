...
$canUseAll:$ este es un valor booleano que nos dice si en la posición actual podemos colocar cualquier dígito entre $0$ y $9$, o solo entre $0$ y el dígito en la posición actual de $n$. Por ejemplo, supongamos que $n=527$ y estamos en $pos=1$, entonces solo podemos colocar dígitos entre el $0$ y el $5$.  
...
Sea $f(n)$ la suma de dígitos de todos los números positivos hasta $n$. Entonces $f(R)-f(L-1)$ nos va a decir la suma deseada.
$dp(pos,canUseAll,sum)$nos dará la suma de cifras de todos los números construidos después de la posisión $pos$, donde $sum$ guarda la suma de cifras de la secuencia de dígitos actual.
