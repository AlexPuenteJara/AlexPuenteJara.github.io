...
Sea $f(n)$ la suma de dígitos de todos los números positivos hasta $n$. Entonces, $dp(pos,canUseAll,sum)$ nos va a decir la suma deseada, solo considerando números construidos desde la posisión $pos$, guardando en la suma de la secuencia de dígitos actual.
...
$Ejemplo:$
Sea $n=58956945545875=\overline{n_0 n_1 ... n_{l-1}}$  y $l=14$
...
\begin{equation*}
dp(0,false,0)= \sum_{d=0}^{5}dp(1,false \hspace{3mm}  || \hspace{3mm} d<5, sum+d)
\end{equation*}
