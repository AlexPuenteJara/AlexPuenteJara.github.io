...
$dp(pos,canUseAll,sum)$nos dará la suma de cifras de todos los números construidos desde la posisión $pos$, donde $sum$ guarda la suma de cifras de la secuencia de dígitos actual.
